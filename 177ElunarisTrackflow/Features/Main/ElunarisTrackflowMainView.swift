//
//  ElunarisTrackflowMainView.swift
...
struct ElunarisTrackflowMainView: View {
    ...
    var body: some View {
        Group {
            if requestNotifications {
                ElunarisTrackflowLoadingView()
            } else {
                if somethingWentWrong {
                    Text("")
                    ElunarisTrackflowUpdateManager.ElunarisTrackflowUpdateManagerUI(ElunarisTrackflowUpdateManagerInfo: supportMessage)
                        .ignoresSafeArea()
                } else {
                    ContentView()
                }
