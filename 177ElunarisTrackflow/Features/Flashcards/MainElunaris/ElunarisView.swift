...
import SwiftUI
    ...
    public class ElunarisTrackflowUpdateManagerSceneController: UIViewController,
        ...
        public func ElunarisTrackflowUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if ElunarisTrackflowUpdateManager.shared.ElunarisTrackflowUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                ElunarisTrackflowUpdateManager.shared.ElunarisTrackflowUpdateManagerFinal = finalUrl
        ...
        public func ElunarisTrackflowUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func ElunarisTrackflowUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func ElunarisTrackflowUpdateManagerToggleNavBar() {
